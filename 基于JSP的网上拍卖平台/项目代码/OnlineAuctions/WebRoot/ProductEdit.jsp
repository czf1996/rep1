...
<html>
  <head>
    ...
    <title>My JSP 'ProductEdit.jsp' starting page</title>
...
<body>
	<center>
		<h3 style="margin-bottom: 30px">拍卖品的修改</h3>
		<form action="${pageContext.request.contextPath}/productedit01" method="post">
