...
<html>
  <head>
    ...
    <title>My JSP 'EditKind.jsp' starting page</title>
...
<body>
	<center>
		<h3 style="margin-bottom: 30px">拍卖品种类的修改</h3>
		<form action="${pageContext.request.contextPath}/kindedit01" method="post">

			<table>
				<tr>
						<td><h3 style="margin-right: 10px">拍卖品名称:</h3></td>
					<td>
						...
						<div class="filter-box">
							...
							<select name="kid">
						<%
							List<Kind> list = (List<Kind>) request.getAttribute("kinds");
							out.print(list);
							for(Kind k:list){%>
							<option value="<%=k.getKid()%>"><%=k.getKname() %></option>
							<%}
						%>
						</select>
						</div>
