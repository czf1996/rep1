...
<title>My JSP 'AdmiEdit.jsp' starting page</title>
...
<body>
	<center>
		<h3 style="margin-bottom: 30px">管理员的修改</h3>
		<form action="admiedit01" method="post">
			<table>
				<tr>
					<td><h3 style="margin-right: 10px">用户名:</h3></td>
					<td>
