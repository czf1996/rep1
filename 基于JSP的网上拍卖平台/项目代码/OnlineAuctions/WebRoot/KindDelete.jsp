...
<html>
  <head>
    ...
    <title>My JSP 'KindDelete.jsp' starting page</title>
...
<body>
	<center>
		<h3 style="margin-bottom: 30px">拍卖品种类的删除</h3>
		<form action="kinddelete" method="post">

			<table>
				<tr>
						<td><h3 style="margin-right: 10px">拍卖品种类名称:</h3></td>
					<td>
